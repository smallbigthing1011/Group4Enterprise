...
const {
  createFirstAdmin,
} = require("../../interface/controllers/AccountController");
...
const createServer = () => {
  ...
  app.use(
    "/accounts",
    AuthorizationController.verifyAccessToken,
    require("../../interface/routes/account")
  );
  app.use("/magazines", require("../../interface/routes/magazine"));
  app.use(
    "/contributions",
    AuthorizationController.verifyAccessToken,
    require("../../interface/routes/contribution")
  );
  app.use(
    "/comments",
    AuthorizationController.verifyAccessToken,
    require("../../interface/routes/comment")
  );
  ...
  app.on("ready", () => {
    app.listen(environment.server.port, () => {
      createFirstAdmin();
      console.log(
        `The server is listening on the port ${environment.server.port}...`
      );
    });
  });
